...
cantidad_anios = int(input("Ingrese una cantidad de años: "))

suma_edad_anios = edad + cantidad_anios

print(f"Hola, {nombre}. Dentro de {cantidad_anios} años tendrás {suma_edad_anios} años.")
